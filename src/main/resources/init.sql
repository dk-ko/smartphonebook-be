...
INSERT INTO USER(CREATED_DATE , MODIFIED_DATE , NAME , EMAIL, ROLE ) VALUES ( CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '테스트유저', 'test@test.com', 'LOGIN_USER'); 

INSERT INTO CONTACT(CREATED_DATE , MODIFIED_DATE, MEMO, NAME, PHOTO, CONTACT_TYPE, USER_ID)  
VALUES (CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '메모', '정소연', '', 1, 1);
INSERT INTO CONTACT(CREATED_DATE , MODIFIED_DATE, MEMO, NAME, PHOTO, CONTACT_TYPE, USER_ID)  
VALUES (CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '테스트', '고다경', '', 2, 1);
INSERT INTO CONTACT(CREATED_DATE , MODIFIED_DATE, MEMO, NAME, PHOTO, CONTACT_TYPE, USER_ID)  
VALUES (CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '효경씌', '연효경', '', 2, 1);
INSERT INTO CONTACT(CREATED_DATE , MODIFIED_DATE, MEMO, NAME, PHOTO, CONTACT_TYPE, USER_ID)  
VALUES (CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '바보', '사봉석', '', 0, 1);
INSERT INTO CONTACT(CREATED_DATE , MODIFIED_DATE, MEMO, NAME, PHOTO, CONTACT_TYPE, USER_ID)  
VALUES (CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '칠렐레', '최윤경', '', 0, 1);
INSERT INTO CONTACT(CREATED_DATE , MODIFIED_DATE, NAME, PHOTO, CONTACT_TYPE, USER_ID)  
VALUES (CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), '김준철', '', 0, 1);
